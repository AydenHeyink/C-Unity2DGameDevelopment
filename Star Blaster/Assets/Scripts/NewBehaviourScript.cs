...
public class WaveConfigSO : ScriptableObject
{
    ...
    [SerializeField] float timeBetweenEnemySpans = 1f;
    ...
    {
        float spawnTime = Random.Range(timeBetweenEnemySpans - enemySpawnVariance,
            timeBetweenEnemySpans + enemySpawnVariance);
